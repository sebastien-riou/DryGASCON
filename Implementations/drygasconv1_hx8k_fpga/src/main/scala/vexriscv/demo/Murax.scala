...
case class Murax(config : MuraxConfig) extends Component{
  ...
  val system = new ClockingArea(systemClockDomain) {
    ...
    val drygascon128 = new MuraxApb3Drygascon128()
    apbMapping += drygascon128.io.apb     -> (0x30000, 4 kB)
...
object MuraxHex{
  def main(args: Array[String]) {
    val hex = "software/projects/murax/demo/build/demo.hex"
    //val hex = "/home/user/workspace/sbl/build/sbl.hex"
    SpinalVerilog(Murax(MuraxConfig.default.copy(onChipRamSize = 8 kB, onChipRamHexFile = hex)))
  }
}
